...
{
    // Lay data
    $name['sv_name']        = isset($_POST['name']) ? $_POST['name'] : '';
    $sex['sv_sex']         = isset($_POST['sex']) ? $_POST['sex'] : '';
    $birthday['sv_birthday']    = isset($_POST['birthday']) ? $_POST['birthday'] : '';
     
   
    $errors = array();
    if (empty($name['sv_name'])){
